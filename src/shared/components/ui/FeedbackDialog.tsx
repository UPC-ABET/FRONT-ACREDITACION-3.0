...
export function FormDialog({ isOpen, onClose, onSubmit, title, children }: FormDialogProps) {
	const { t } = useI18n();
...
export function ErrorDialog({ isOpen, onClose, title, message }: BaseDialogProps) {
	const { t } = useI18n();
...
export function SuccessDialog({ isOpen, onClose, title, message }: BaseDialogProps) {
	const { t } = useI18n();
...
export function InfoDialog({ isOpen, onClose, title, message }: BaseDialogProps) {
	const { t } = useI18n();
