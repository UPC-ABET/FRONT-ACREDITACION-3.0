...
export interface SelectProps {
	...
	options: Array<
		OptionItem | { id?: string | number; value?: string | number; name?: string; label?: string }
	>;
	label?: string;
	error?: string;
	isMulti?: boolean;
...
function Select({
	...
	return (
		<div className="flex flex-col w-full">
			...
			{error && (
				<p className="font-medium text-xs mt-2 text-red-500 italic leading-none">{error}</p>
			)}
		</div>
	);
}
