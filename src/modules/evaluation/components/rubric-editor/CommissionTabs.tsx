        ...
        {commissions.map((commission) => {
          ...
          return (
            <div
              ...
              className={`flex cursor-pointer items-center gap-2 rounded-t-lg border-b-2 px-4 py-3 text-sm font-medium transition-colors outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 ${isActive
            ...
            >
              ...
              {status === 'complete' ? (
                ...
                <ExclamationTriangleIcon className="h-4 w-4 shrink-0 text-amber-500" title="Incomplete" />
              ) : (
                <span className="inline-block h-4 w-4 shrink-0 rounded-full bg-zinc-200" aria-hidden />
              )}
