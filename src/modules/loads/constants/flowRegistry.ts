...
const flowsList: UploadFlow[] = [
	{ typeCode: 'TG1101-T001', slug: 'staff' },
	...
	{ typeCode: 'TG1101-T007', slug: 'grades-rv' },
	...
	{ typeCode: 'TG1101-T013', slug: 'class-representatives' },
	{ typeCode: 'TG1101-T014', slug: 'project-grades' },
].map(({ typeCode, slug }) => ({
	typeCode,
	slug,
