...
export default function ModalsDemoPage() {
	...
	return (
		<div className="space-y-8">
			...
			<FormDialog isOpen={openForm} onClose={() => setOpenForm(false)} onSubmit={handleSubmitForm}>
				...
				<div className="mt-4 flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-10">
					<HoverCard openDelay={10} closeDelay={100}>
						...
						<HoverCardContent className="flex flex-col gap-3">
							<div className="text-sm text-zinc-700">Lista de alumnos matriculados al 202-01.</div>
						</HoverCardContent>
					</HoverCard>
				</div>
			</div>
