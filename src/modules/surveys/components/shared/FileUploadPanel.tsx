...
export function FileUploadPanel({
  ...
  React.useEffect(() => {
    if (success) {
      setToast({ open: true, type: 'success', msg: 'Archivo procesado exitosamente. Se descargó el reporte.' })
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-200 space-y-3">
        ...
        >
          ...
          <p className="text-xs text-zinc-400">Formatos aceptados: {accept} · Máx. {MAX_SIZE_MB}MB</p>
        </div>
