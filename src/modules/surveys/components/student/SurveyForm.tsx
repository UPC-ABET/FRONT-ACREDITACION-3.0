...
export function SurveyForm({
  ...
  function handleSubmit() {
    ...
    if (!allAnswered) {
      setToast({ open: true, type: 'error', msg: 'Por favor, completa todos los outcomes antes de enviar.' })
      return
    }
    if (!comentario.trim()) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="bg-white border-b border-zinc-200 sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between text-xs text-zinc-500 mb-1">
            <span>Progreso</span>
            <span>{answeredOutcomes} de {totalOutcomes} respondidos ({progress}%)</span>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        {outcomes.map((group) => (
          <div key={group.comisionId} className="bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden">
