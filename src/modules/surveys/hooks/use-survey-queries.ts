...
export const surveyQueryKeys = {
  ...
  graStudents: (params: { program_id?: number; academic_period_id?: number; campus_id?: number; student_code?: string }) =>
    ['surveys', 'gra', 'students', params] as const,
  graAcceptanceLevels: (periodId: number) =>
    ['surveys', 'gra', 'acceptance-levels', periodId] as const,
  graDashboard: (params: { academic_period_id?: number; program_id?: number; campus_id?: number }) =>
  ...
  lcfcDashboard: (params: { academic_period_id?: number; program_id?: number; campus_id?: number }) =>
  ...
  pppDashboard: (params: { academic_period_id?: number; program_id?: number; campus_id?: number; practice_number?: number }) =>
...
export function useGRAStudentsQuery(
  params: { program_id?: number; academic_period_id?: number; campus_id?: number; student_code?: string },
  options?: { enabled?: boolean },
) {
  return useQuery({
...
export function useGenerateLCFCConfiguration() {
  ...
  return useMutation({
    mutationFn: (params: {
      ...
      program_id?: number
      campus_id?: number
    }) => generateLCFCConfiguration(params.escuela, params.academic_period_id, params.program_id, params.campus_id),
    onSuccess: () => {
...
export function usePPPDashboardQuery(
  params: { academic_period_id?: number; program_id?: number; campus_id?: number; practice_number?: number },
  options?: { enabled?: boolean },
) {
  return useQuery({
