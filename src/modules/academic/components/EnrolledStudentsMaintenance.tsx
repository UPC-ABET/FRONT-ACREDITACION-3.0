...
export function EnrolledStudentsMaintenance() {
	...
	// A new search or a period switch always returns to the first page.
		...
		<Card>
			<div className="space-y-5">
				<div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
					<div className="space-y-1">
						...
						<p className="text-sm text-gray-500">
							{t('loads.enrolledStudentsMaintenance.subtitle')}
						</p>
					</div>
				...
				{academicPeriodId == null ? (
					renderNotice(t('loads.enrolledStudentsMaintenance.selectPeriod'))
				) : isError ? (
